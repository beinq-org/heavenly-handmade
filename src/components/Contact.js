      ...
      <h1>&bull; Get in Touch &bull;</h1>
        ...
        <form action="#" method="post" id="contact_form">
            <div class="name">
                ...
                <input type="text" placeholder="Enter Full Name" name="name" id="name_input" required></input>
            </div>
            
            <div class="email">
                <label for="email"></label>
                <input type="email" placeholder="Enter Contact Number" name="email" id="email_input" required></input>
            </div>
            
            <div class="telephone">
                <label for="name"></label>
                <input type="text" placeholder="Enter E-Mail ID" name="telephone" id="telephone_input" required></input>
            </div>
